...
export default function LinkDrawer({ icon, text, path, onClick }: LinkDrawerProps) {
	...
	const content = (
		<>
			{icon}
			<h1 className="text-[#746352] max-w-0 opacity-0 translate-x-[-10px] group-hover:max-w-full group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ease-in-out scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance pr-0 group-hover:pr-4 group-hover:py-2 whitespace-nowrap">
				{text}
			</h1>
		</>
	)
